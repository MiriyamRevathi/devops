"""
Workflow Execution Engine for incidents.
...
class IncidentsWorkflowEngine:
    """Executes ordered multi-step workflows for incidents."""
    WORKFLOW_STEPS = ["VALIDATE", "PROVISION", "VERIFY", "COMPLETE"]

    def __init__(self, workflow_name: str = "incidents_standard_workflow"):
