"""
Workflow Execution Engine for changes.
...
class ChangesWorkflowEngine:
    """Executes ordered multi-step workflows for changes."""
    WORKFLOW_STEPS = ["VALIDATE", "PROVISION", "VERIFY", "COMPLETE"]

    def __init__(self, workflow_name: str = "changes_standard_workflow"):
