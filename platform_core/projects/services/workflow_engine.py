"""
Workflow Execution Engine for projects.
...
class ProjectsWorkflowEngine:
    """Executes ordered multi-step workflows for projects."""
    WORKFLOW_STEPS = ["VALIDATE", "PROVISION", "VERIFY", "COMPLETE"]

    def __init__(self, workflow_name: str = "projects_standard_workflow"):
