"""
Workflow Execution Engine for containers.
...
class ContainersWorkflowEngine:
    """Executes ordered multi-step workflows for containers."""
    WORKFLOW_STEPS = ["VALIDATE", "PROVISION", "VERIFY", "COMPLETE"]

    def __init__(self, workflow_name: str = "containers_standard_workflow"):
