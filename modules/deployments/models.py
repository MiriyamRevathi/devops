"""
Domain entity models and data structures for deployments.
...
class DeploymentsEntity:
    """Domain model for deployments entity."""
    def __init__(self, name: str, description: str = "", entity_id: Optional[str] = None, status: str = "ACTIVE", metadata: Optional[Dict[str, Any]] = None):
        self.id = entity_id or generate_id("dep")
        self.name = name
