...
class ProjectsDomainService:
    """Service managing projects domain operations."""
    def __init__(self, data_dir: str):
        self.store = JSONStore(data_dir, "projects_entities.json")
    ...
    def create_entity(self, name: str, description: str = "") -> Tuple[bool, Optional[Dict[str, Any]], str]:
        ...
        EventBus.publish("projects_entity_created", entity_id=record["id"])
