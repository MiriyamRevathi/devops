"""
Service layer for alerts operations.
"""
...
class AlertsDomainService:
    """Service managing alerts domain operations."""
    def __init__(self, data_dir: str):
        self.store = JSONStore(data_dir, "alerts_entities.json")
    ...
    def create_entity(self, name: str, description: str = "") -> Tuple[bool, Optional[Dict[str, Any]], str]:
        ...
        EventBus.publish("alerts_entity_created", entity_id=record["id"])
