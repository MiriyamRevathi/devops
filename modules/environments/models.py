"""
Domain entity models and data structures for environments.
...
class EnvironmentsEntity:
    """Domain model for environments entity."""
    def __init__(self, name: str, description: str = "", entity_id: Optional[str] = None, status: str = "ACTIVE", metadata: Optional[Dict[str, Any]] = None):
        self.id = entity_id or generate_id("env")
        self.name = name
